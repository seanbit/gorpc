...
var ClientLogger = &clientLogger{log: logrus.New()}
...
func (this *clientLogger) PostCall(ctx context.Context, servicePath, serviceMethod string, args interface{}, reply interface{}, err error) error {
	...
	calllog := this.log.WithFields(logrus.Fields{"traceId":traceId, "userName":userName, "callPath":servicePath, "callMethod":serviceMethod, "callArgs":argsInfo, "callReply":replyInfo})
	if err != nil {
